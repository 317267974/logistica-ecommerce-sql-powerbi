...
| [`medidas_dax.md`](medidas_dax.md) | Modelo, relaciones y 18 medidas DAX |
| [`dashboard_logistica.pbix`](dashboard_logistica.pbix) | Dashboard de Power BI (3 páginas: resumen ejecutivo, retrasos y satisfacción del cliente) |
| [`diseno_dashboard.md`](diseno_dashboard.md) | Diseño de las páginas del dashboard |
...
5. Crea el calendario, las relaciones y las medidas de [`medidas_dax.md`](medidas_dax.md).
